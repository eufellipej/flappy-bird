...
class Botao:
    def __init__(self, tela, texto, x, y, corFundo, corTexto):
        self.tela = tela
        self.texto = Texto(tela, texto, x, y, corTexto, 50)
        self.posicao = (x, y)
    ...
    def get_click(self):
        ...
        return rect.collidepoint(posicaoMouse) and pygame.mouse.get_pressed()[0]
